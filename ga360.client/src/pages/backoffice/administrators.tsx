...
export default function Administrators({ triggerAddCandidate = false, onModalClose = () => {} }) {
    ...
    return (
        <Grid>
            {allowedCustomers === undefined ? <>Loading...</> : <>
                ...
                <CustomerModal open={customerModal} modalToggler={setCustomerModal} customer={selectedCustomer} customerType="Super Admin" />
            </>
            }
        </Grid>
    )
